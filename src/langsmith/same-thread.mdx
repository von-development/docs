...
---
In LangSmith Platform, a thread is not explicitly associated with a particular agent.
...
You'll see that the second agent will respond using information from the [checkpoint](/oss/langgraph/graph-api#checkpointer-state) generated in the thread by the first agent as context.
