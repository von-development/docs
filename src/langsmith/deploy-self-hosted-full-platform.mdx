...
Before setting up LangSmith Platform with agent deployment, review the [self-hosting overview page](/langgraph-platform/self-hosted#with-agent-deployment).

<Info>
**Important**
Self-hosting LangSmith Platform with agent deployment requires an [Enterprise](/langgraph-platform/plans) plan.
</Info>
