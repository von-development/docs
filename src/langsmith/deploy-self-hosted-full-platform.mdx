---
title: Self-host LangSmith Platform with agent deployment
sidebarTitle: With agent deployment
icon: "server"
---

Before setting up LangSmith Platform with agent deployment, review the [self-hosting overview page](/langsmith/self-hosted#with-agent-deployment).

<Info>
**Important**
Self-hosting LangSmith Platform with agent deployment requires an [Enterprise](/langsmith/plans) plan.
</Info>
...
1. As part of configuring your self-hosted LangSmith instance, you enable the `langgraphPlatform` option. This will provision a few key resources.
    ...
    2. `LangGraphPlatform CRD`: A CRD for LangSmith Platform deployments. This contains the spec for managing an instance of a LangGraph platform deployment.
    3. `operator`: This operator handles changes to your LangSmith Platform CRDs.
