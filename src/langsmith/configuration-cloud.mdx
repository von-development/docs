...
To create an assistant, use the [LangGraph SDK](/langsmith/sdk) `create` method. See the [Python](/langsmith/python-sdk#langgraph_sdk.client.AssistantsClient.create) and [JS](/langsmith/js-ts-sdk#create) SDK reference docs for more information.
...
You can also create assistants from the LangSmith Platform UI.
...
To confirm, click "Create assistant". This will take you to [Studio](/langsmith/langgraph-studio) where you can test the assistant. If you go back to the "Assistants" tab in the deployment, you will see the newly created assistant in the table.
...
To edit the assistant, use the `update` method. This will create a new version of the assistant with the provided edits. See the [Python](/langsmith/python-sdk#langgraph_sdk.client.AssistantsClient.update) and [JS](/langsmith/js-ts-sdk#update) SDK reference docs for more information.
...
You can also edit assistants from the LangSmith Platform UI.
