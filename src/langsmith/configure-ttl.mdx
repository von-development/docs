...
<Tip>
**Prerequisites**
This guide assumes familiarity with the [LangSmith Platform](/langsmith/home), [Persistence](/oss/langgraph/persistence), and [Cross-thread persistence](/oss/langgraph/persistence#memory-store) concepts.
</Tip>
