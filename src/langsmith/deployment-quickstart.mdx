...
2. Click the **Studio** button in the top right corner. [Studio](/langgraph-platform/langgraph-studio) will open to display your graph.
...
* [Studio overview](/langgraph-platform/langgraph-studio)
