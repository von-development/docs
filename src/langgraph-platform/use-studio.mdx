...
1. Click the **Submit** button. This will add a [run](/langgraph-platform/assistants#execution) to the existing selected [thread](/oss/langgraph/persistence#threads). If no thread is currently selected, a new one will be created.
...
- [Iterate on prompts](#observability-studio)
