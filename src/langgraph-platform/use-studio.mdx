...
1. To create a new thread, click **+** and [submit a run](/langsmith/use-studio#run-application#chat-mode).
...
- [Iterate on prompts](/langsmith/observability-studio#iterate-on-prompts)
