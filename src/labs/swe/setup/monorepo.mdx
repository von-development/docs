...
<Note>
  This postinstall hook is **required** for LangSmith Platform deployment. Since
...
1. **Deployment Compatibility**: The LangSmith Platform needs all dependencies built and available
