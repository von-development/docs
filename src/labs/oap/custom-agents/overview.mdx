...
OAP is built on top of LangSmith Platform, which means all agents which you build to be used in OAP must be LangGraph agents deployed on LangSmith Platform.
...
2. Deploying your agent to LangSmith Platform
