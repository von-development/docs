...
Choose from cloud, hybrid, or self-hosted deployments based on your infrastructure requirements. For more details, refer to the [Deployment options](/langsmith/deployment-options) page.
...
<Columns cols={3}>
    ...
    <Card
        ...
        icon="play"
        href="/langsmith/langgraph-studio"
        arrow="true"
        cta="Learn more"
    >
...
<Columns cols={3}>
    ...
    <Card
        ...
        icon="server"
        href="/langsmith/data-plane#redis"
        arrow="true"
        cta="Learn more"
    >
    ...
    <Card
        ...
        icon="split"
        href="/langsmith/interrupt-concurrent"
        arrow="true"
        cta="Learn more"
    >
    ...
    <Card
        ...
        icon="user-check"
        href="/langsmith/add-human-in-the-loop"
        arrow="true"
        cta="Learn more"
    >
