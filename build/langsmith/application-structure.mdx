...
This guide shows a typical structure of an application and shows how the required information to deploy an application using the LangSmith Platform is specified.

## Key Concepts

To deploy using the LangSmith Platform, the following information should be provided:
