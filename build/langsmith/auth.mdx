...
In LangGraph Platform, authentication is handled by your [`@auth.authenticate`](/langsmith/python-sdk#langgraph_sdk.auth.Auth.authenticate) handler, and authorization is handled by your [`@auth.on`](/langsmith/python-sdk#langgraph_sdk.auth.Auth.on) handlers.
