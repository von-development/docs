...
LangSmith Platform provides a flexible authentication and authorization system that can integrate with most authentication schemes.
...
In LangSmith Platform, authentication is handled by your [`@auth.authenticate`](/langsmith/python-sdk#langgraph_sdk.auth.Auth.authenticate) handler, and authorization is handled by your [`@auth.on`](/langsmith/python-sdk#langgraph_sdk.auth.Auth.on) handlers.

## Default Security Models

LangSmith Platform provides different security defaults:
...
<Note>
**Custom auth**
Custom auth **is supported** for all plans in LangSmith Platform.
</Note>
