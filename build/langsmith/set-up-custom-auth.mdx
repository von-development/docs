...
<Note>
Custom auth is only available for LangSmith Platform SaaS deployments or Enterprise Self-Hosted deployments.
</Note>
...
> For production use, please use LangSmith Platform.
```
