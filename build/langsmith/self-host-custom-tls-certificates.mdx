...
To use custom TLS certificates, you need to set the following environment variables. See the [self hosted deployment section](/langsmith/self-hosted) for more information on how to set up application configuration.
