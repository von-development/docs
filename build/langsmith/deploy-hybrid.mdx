---
title: Set up hybrid LangSmith Platform
sidebarTitle: Setup guide
icon: "cloud"
---

Before setup, review the [overview on hybrid](/langsmith/hybrid) LangSmith Platform.

<Info>
**Important**
The Hybrid deployment option requires an [Enterprise](/langsmith/plans) plan.
</Info>
