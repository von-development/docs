...
![Brave Shields panel with Shields turned off for smith.langchain.com so Studio can reach localhost.](/langsmith/images/brave-shields.png)
...
- **Deployed application**: If your application is deployed on LangSmith Platform, you may need to create a new revision to enable this feature.
