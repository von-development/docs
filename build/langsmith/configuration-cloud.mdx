...
To confirm, click "Create assistant". This will take you to [Studio](/langgraph-platform/langgraph-studio) where you can test the assistant. If you go back to the "Assistants" tab in the deployment, you will see the newly created assistant in the table.
