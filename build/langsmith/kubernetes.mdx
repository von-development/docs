---
title: Self-host LangSmith Platform on Kubernetes
...
This page describes how to set up [LangSmith Platform](/langsmith/self-hosted#langsmith-platform) in a Kubernetes cluster. You'll use Helm to install LangSmith Platform and its dependencies.

We've successfully tested LangSmith Platform on the following Kubernetes distributions:
