...
The easiest way to get started with a model in LangChain is to use `init_chat_model` to initialize one from a [provider](/oss/javascript/integrations/providers) of your choice (examples below):
